...
<p>Search your uploaded documents using natural language.</p>""",
                ...
                if st.button("Open Search", use_container_width=True, key="search_button"):
                    st.switch_page("pages/3_🤖_AI_Search.py")
        ...
        pg = st.navigation(
            {
                ...
                "Administration": [
                    st.Page("pages/1_📥_Ingest.py", title="Upload Documents", icon="📤"),
                    st.Page("pages/4_👥_Manage_Users.py", title="Manage Users", icon="👥"),
                    st.Page("pages/10_📢_Announcements.py", title="Announcements", icon="📢"),
                ],

                "Exam": [
                    st.Page("pages/6_📝_Create_Exam.py", title="Create Exam", icon="📝"),
                    st.Page("pages/9_📊_Results.py", title="Results", icon="📊"),
                ],

                "AI": [
                    st.Page("pages/2_🔍_Search.py", title="Search", icon="🔍"),
                    st.Page("pages/3_🤖_AI_Search.py", title="AI Search", icon="🤖"),
                ],
            }
        )
        ...
        pg = st.navigation(
            {
                ...
                "Exam": [
                    st.Page("pages/7_📝_My_Exams.py", title="My Exams", icon="📝"),
                    st.Page("pages/8_📝_Take_Exam.py", title="Take Exam", icon="✍️"),
                    st.Page("pages/9_📊_Results.py", title="Results", icon="📊"),
                    st.Page("pages/10_📢_Announcements.py", title="Announcements", icon="📢"),
                ],
